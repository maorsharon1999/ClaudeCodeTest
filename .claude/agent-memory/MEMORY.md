...
- [`product-architect/`](product-architect/) — Product decisions and scope definitions from prior slices and planning

## Design & Motion
- [`design-motion-director/`](design-motion-director/) — Visual design, theme, and animation patterns from prior implementations
